 ...
 * 
 * Update BDAPPS_APP_ID and BDAPPS_APP_PASSWORD below with your credentials from dev.bdapps.com.
...
define('BDAPPS_APP_PASSWORD', trim(getenv('BDAPPS_APP_PASSWORD') ?: 'y0e74fafba35bd80a3e484ca07ab43715'));
